# -*- coding: utf-8 -*-
"""
Created on Mon Jun 29 19:50:57 2020
...
for i,anio in enumerate(anios_elecciones_legislativas):
    ...
    dict_sesiones_desacuerdo = f.enlaces_por_sesion_desacuerdo(dict_enlaces_periodo_i,nodos)
    red_acuerdos_i = f.red_pesada(dict_enlaces_periodo_i)
